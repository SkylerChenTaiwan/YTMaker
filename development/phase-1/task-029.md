...
| 任務 | 名稱 | 預估時間 | 依賴 | 狀態 |
|------|------|---------|------|------|
| **Task-029A** | 測試基礎設施 | 3 小時 | - | ⏳ 未開始 |
| **Task-029B** | 核心流程測試 | 6 小時 | 029A | ⏳ 未開始 |
| **Task-029C** | 進階功能測試 | 5 小時 | 029A | ⏳ 未開始 |
| **Task-029D** | 整合與部署 | 2 小時 | 029B, 029C | ⏳ 未開始 |
...
#### E2E 測試 1: Flow-0 首次啟動設定流程 → Task-029B
